...
const StatusValidasiList = () => {
    ...
    useEffect(() => {
		const fetchData = async () => {
		  try {
			const data = await FirestoreService.getDocuments('statusValidasi');
			setList(data);
	...
	const tableColumns = [
		...
		{
			title: 'Nama Status Valdasi Clash',
			dataIndex: 'namaStatusValidasi',
			
			sorter: (a, b) => utils.antdTableSorter(a, b, 'namaStatusValidasi')
		},
		{
			title: 'Ket Status Validasi Clash',
			dataIndex: 'ketStatusValidasi',
			sorter: (a, b) => utils.antdTableSorter(a, b, 'ketStatusValidasi')
		},
		{
			title: '',
			dataIndex: 'actions',
